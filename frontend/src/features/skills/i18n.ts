...
const englishSkillsCopy = {
  ...
  detail: {
    ...
    sourcePackage: {
      ...
      individualSkillCopySupported: "Individual skill copying is supported",
      packageDeploymentUnsupported: "Package deployment is not supported",
  ...
  "zh-CN": {
    ...
    detail: {
      ...
      sourcePackage: {
        ...
        individualSkillCopySupported: "支持复制单个 Skill",
        packageDeploymentUnsupported: "不支持部署整个包",
